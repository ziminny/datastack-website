...
export function Installation({ translation }: InstallationProps) {
  const spmCode = `dependencies: [
    .package(url: "https://github.com/ziminny/DataStack.git", from: "1.0.0")
]`;

  const cocoapodsCode = `pod 'DataStack', :git => 'https://github.com/ziminny/DataStack.git'`;
      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Add DataStack to your project using your preferred package manager
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="p-6 gradient-card border-border/50 shadow-custom animate-fade-up">
              ...
              <p className="text-muted-foreground mb-4">
                Add DataStack to your project dependencies:
              </p>
