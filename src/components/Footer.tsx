    ...
    <footer className="border-t border-border bg-background">
      <div className="container py-12">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-foreground">DataStack</span>
            </div>
            <p className="text-muted-foreground">
              A modular Swift CoreData framework designed for flexibility, speed, and ease of integration.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li>
                <a 
                  href="https://github.com/ziminny/DataStack" 
                  target="_blank" 
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground">
            © 2025 DataStack. Licensed under the MIT License.
          </p>
